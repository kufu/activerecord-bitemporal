  ...
  module Bitemporal
    ...
    module Persistence
      ...
      def _create_record(attribute_names = self.attribute_names)
        ...
        ActiveRecord::Bitemporal.valid_at!(self._valid_from) {
          super()
        }
      end
      ...
      def _update_row(attribute_names, attempted_action = 'update')
        ...
        ActiveRecord::Base.transaction(requires_new: true) do
          ...
          self._valid_from = after_instance._valid_from
          self._valid_to = after_instance._valid_to
          ...
          _run_destroy_callbacks {
            ...
            unless force_update?
              ...
              if @destroyed
                ...
                self._valid_from = duplicated_instance._valid_from
                self._valid_to = duplicated_instance._valid_to
      ...
      def bitemporal_assign_initialize_value(valid_datetime:, current_time: Time.current)
        # 自身の `valid_from` を設定
        self._valid_from = valid_datetime || current_time if self._valid_from == ActiveRecord::Bitemporal::DEFAULT_VALID_FROM
      ...
      def bitemporal_build_update_records(valid_datetime:, current_time: Time.current, force_update: false)
        ...
        # 有効なレコードがない場合
          ...
          # 以降の履歴データは valid_from と valid_to を調整して保存する
          after_instance._valid_from = target_datetime
          after_instance._valid_to = nearest_instance._valid_from
          after_instance.transaction_from = current_time
        end
    ...
    module Uniqueness
      ...
      def scope_relation(record, relation)
        ...
        valid_from = record._valid_from.yield_self { |valid_from|
        ...
        valid_from = record._valid_from if record.force_update?
